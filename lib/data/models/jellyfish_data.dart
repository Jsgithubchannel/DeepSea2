...
class JellyfishData {
  ...
  static final List<Jellyfish> jellyfishList = [
    ...
    Jellyfish(
      ...
      imageUrl: 'assets/images/jellyfish/compass_jellyfish.png', // 이미지 경로 확인 필요
      colors: ['노랑', '갈색', '주황'],
    ...
    Jellyfish(
      ...
      imageUrl: 'assets/images/jellyfish/blue_jellyfish.png', // 이미지 경로 확인 필요
      colors: ['파랑', '보라'],
    ...
    Jellyfish(
      ...
      dangerLevel: DangerLevel.severe,
      imageUrl: 'assets/images/jellyfish/mauve_stinger.png', // 이미지 경로 확인 필요
      colors: ['보라', '분홍', '노랑'],
    ...
    Jellyfish(
      ...
      dangerLevel: DangerLevel.mild,
      imageUrl: 'assets/images/jellyfish/barrel_jellyfish.png', // 이미지 경로 확인 필요
      colors: ['흰색', '파랑', '보라', '노랑'],
